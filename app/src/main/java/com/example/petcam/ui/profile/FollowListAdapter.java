...
public class FollowListAdapter extends RecyclerView.Adapter<FollowListAdapter.ViewHolder> {
    ...
    private final List<FollowListItem> mList;
    private final Context mContext;


    public FollowListAdapter(List<FollowListItem> mList, Context mContext, OnListItemSelectedInterface listener) {
        this.mList = mList;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        FollowListItem item = mList.get(position);
