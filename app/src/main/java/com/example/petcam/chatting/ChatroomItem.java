...
public class ChatroomItem {
    ...
    @SerializedName("chatroom_id") private String chatroom_id;
    @SerializedName("chatroom_name") private String chatroom_name;
    @SerializedName("chatroom_user_profile") private String chatroom_user_profile;
    @SerializedName("chatroom_user_num") private String chatroom_user_num;
    @SerializedName("last_message") private String last_message;
    @SerializedName("last_message_time") private String last_message_time;
    @SerializedName("day_check") private String day_check;
    @SerializedName("view_type") private int view_type;
    @SerializedName("unread_message_num") private String unread_message_num;
