...
public class FixTopNoticeItem {
    ...
    @SerializedName("fix_top_notice_title") private String notice_title;
    @SerializedName("fix_top_notice_contents") private String notice_contents;
    @SerializedName("fix_top_create_at") private String create_at;
